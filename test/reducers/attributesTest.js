...
describe('attributes', () => {
	...
	describe('INCREMENT_ATTRIBUTE', () => {
		it('should make a new state with the attribute increased by 1', () => {
			const newState = reducer(state, {type: 'INCREMENT_ATTRIBUTE', parameter: {attribute: 'bod', min: 1, max: 6}});
		...
		it('should set the new state attribute to the minimum if too low', () => {
			const minimum = 3;
			const newState = reducer(state, {type: 'INCREMENT_ATTRIBUTE', parameter: {attribute: 'bod', min: minimum, max: 6}});
		...
		it('should not let an attribute be higher then the max', () => {
			const maximum = 6;
			const newState = reducer(state, {type: 'INCREMENT_ATTRIBUTE', parameter: {attribute: 'cha', min: 1, max: maximum}});
	...
	describe('DECREMENT_ATTRIBUTE', () => {
		it('should make a new state with the attribute decreased by 1', () => {
			const newState = reducer(state, {type: 'DECREMENT_ATTRIBUTE', parameter: {attribute: 'agi', min: 1, max: 6}});
		...
		it('should set the new state attribute to the maximum if too high', () => {
			const maximum = 4;
			const newState = reducer(state, {type: 'DECREMENT_ATTRIBUTE', parameter: {attribute: 'log', min: 1, max: maximum}});
		...
		it('should not let an attribute be lower then the minimum', () => {
			const minimum = 3;
			const newState = reducer(state, {type: 'DECREMENT_ATTRIBUTE', parameter: {attribute: 'str', min: minimum, max: 8}});
